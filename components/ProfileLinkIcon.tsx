...
/**
 * Marks for the profile links. lucide-react dropped brand icons in v1, so
 * the three services carry their own glyphs (paths from simple-icons,
 * CC0) and only the generic "Website" comes from lucide. Matching each
 * service's real mark is the point — a row of look-alike generic icons
 * would say less than the labels beside them already do.
 */
